...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0xoktrw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0xoktrw.containers.anotherwebservice.com/
...
```
git clone git@github.com:InitialXKO/container-0xoktrw.git
cd container-0xoktrw
```
...
```
docker attach container-0xoktrw
```
